...
const char kWindowTitle[] = "LE2A_13_ホリケ_ハヤト_確認課題00_02";
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreenPrintf(kColumnWidth * 5, 0, transposeM1, "transpose1");
		MatrixScreenPrintf(kColumnWidth * 5, kRowHeight * 5, transposeM2, "transpose2");
